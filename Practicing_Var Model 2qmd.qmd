...
The model I practice will be a VAR in which I aim to discorver how the exchange rate behaves when the economy is affected by uncertaint, speculation and fiscal shocks.
...
data_var = cbind(e, demand = e, supply = e)
...
est_model <- vars::VAR(data_var, lag.max = 4)
